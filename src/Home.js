  ...
  <div>
    ...
    <div className="padding_tops">
      ...
      <p className="homeintros">
        Thank you for using PetSpot We’re here to help you every step of the way from “just looking” at pets, to bringing your pet home, to living a long and happy life with your new family member.
    </p>
    </div>
    <hr />
    ...
    >
      <Col>
        <Card
          ...
          className='same_size'
        >
          <Card.Header><b>Adoption FAQs</b></Card.Header>
          <Card.Body>
            <Card.Text>
              <b>What are the requirements to adopt a pet?</b>
              <ul>
                <li>Proof that you’re at least 18 years of age.</li>
                <li>A picture ID with your current address, or if this isn’t available, a picture ID and a current utility bill.</li>
                <li>A meeting with one of our pet adoption counselors.</li>
              </ul>
              <b>Where can I go to adopt a pet?</b>
              <ul>
                <li>Every pet have an adoption button to contact the user or shelter</li>
              </ul>
              <b>What steps are involved?</b>
              <ul>
                <li>Once you’ve found a pet you’re interested in adopting, use the adopt button!</li>
                <li>We will look up any information we may have on the animal you’ve chosen and help you interact with them.</li>
                <li>The shelter is going to contact you and start the adoption paper work</li>
              </ul>
      ...
      <Col>
        <Card
          ...
          className='same_size'
        >
          <Card.Header><b>Checklist</b></Card.Header>
          <Card.Body>
            ...
            <Card.Text>
              <ul>
                ...
                <li>Are you intolerant of hair, dirt and other realities of sharing your home with a pet, such as allergies?</li>
                <li>Do you or any of your household/family members have health issues that may be affected by a pet?</li>
                <li>What do you expect your pet to contribute to your life? For example, do you want a running and hiking buddy, or is your idea of exercise watching it on TV?</li>
                <li>Have you considered your lifestyle carefully and determined whether a younger or older animal would be a better match for you?</li>
                <li>Can you train and handle a pet with behavior issues or are you looking for an easy-going friend?</li>
                <li>Do you need a pet who will be reliable with children or one you can take with you when you travel?</li>
              </ul>
            </Card.Text>
          </Card.Body>
        </Card>
